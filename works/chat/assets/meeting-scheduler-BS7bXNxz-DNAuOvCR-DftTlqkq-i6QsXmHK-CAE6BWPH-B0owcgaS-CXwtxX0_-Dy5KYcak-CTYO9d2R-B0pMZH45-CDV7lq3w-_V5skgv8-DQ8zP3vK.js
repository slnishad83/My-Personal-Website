import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{C as t,E as n,H as r,J as i,K as a,N as o,P as s,S as c,T as l,W as u,X as d,Z as f,a as p,c as m,f as h,g,h as _,i as v,it as y,j as b,k as x,l as S,n as C,o as w,q as T,rt as E,st as D,t as O,tt as k,u as A,v as j,w as M,x as N,y as P,z as F}from"./feature-security-BOsqIJu9.js";var I,L;e((()=>{y(),u(),D((()=>{i(),E(),f((()=>{F(),l(),T((()=>{s(),g(),r((()=>{n(),h(),k((()=>{w(),m(),v((()=>{a(),c(),p((()=>{j(),P(),C((()=>{_(),O(),N((()=>{x(),t(),M((()=>{S(),o(),A((()=>{b(),I=d((()=>{(function(){function e(){window._openMeetingCreator=function(){!window.App||!window.App.currentChat||n()},t(),o()}function t(){let e=()=>{let e=document.getElementById(`attachment-menu`)||document.getElementById(`_att-menu`);if(!e||e.querySelector(`.meeting-attach-btn`))return;let t=document.createElement(`button`);t.className=`meeting-attach-btn flex flex-col items-center gap-2 p-4 bg-surface-container-highest rounded-2xl hover:bg-surface-variant transition-all`,t.onclick=()=>{window._removeAttMenu&&window._removeAttMenu(),window._openMeetingCreator()},t.innerHTML=`
