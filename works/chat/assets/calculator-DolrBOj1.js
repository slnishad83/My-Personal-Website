import{t as e}from"./modulepreload-polyfill-1QPZNIo4.js";var t=e((()=>{(function(){let e=null,t=!1,n=0,r=0,i=null,a=null,o=``,s=`0`,c=[];function l(){u(),d(),f(),g()}function u(){if(document.getElementById(`calc-styles`))return;let e=document.createElement(`style`);e.id=`calc-styles`,e.textContent=`
      .calc-widget {
        position: fixed;
        right: 24px;
        top: 80px;
