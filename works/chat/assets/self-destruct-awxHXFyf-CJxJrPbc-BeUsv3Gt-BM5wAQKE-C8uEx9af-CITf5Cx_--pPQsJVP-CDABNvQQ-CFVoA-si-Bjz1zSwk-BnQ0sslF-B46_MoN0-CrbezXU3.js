import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{C as t,E as n,H as r,J as i,K as a,N as o,P as s,S as c,T as l,W as u,X as d,Z as f,a as p,c as m,f as h,g,h as _,i as v,it as y,j as b,k as x,l as S,n as C,o as w,q as T,rt as E,st as D,t as O,tt as k,u as A,v as j,w as M,x as N,y as P,z as F}from"./feature-security-BOsqIJu9.js";var I,L;e((()=>{y(),u(),D((()=>{i(),E(),f((()=>{F(),l(),T((()=>{s(),g(),r((()=>{n(),h(),k((()=>{w(),m(),v((()=>{a(),c(),p((()=>{j(),P(),C((()=>{_(),O(),N((()=>{x(),t(),M((()=>{S(),o(),A((()=>{b(),I=d((()=>{(function(){let e=null,t=`nsl_disappearing_default`,n={getGlobalDefault(){try{return parseInt(localStorage.getItem(t)||`0`,10)}catch{return 0}},setGlobalDefault(e){try{localStorage.setItem(t,e.toString())}catch{}},applyDefaultToNewChats(e){let t=this.getGlobalDefault();if(t>0&&App.db&&App.auth?.currentUser){let n=(App.chats||[]).find(t=>t.id===e);if(n&&!n.ephemeralTimer){let r=n.type===`group`?`groups`:`directChats`;App.db.collection(r).doc(e).update({ephemeralTimer:t}).catch(()=>{})}}},openGlobalDefaultSettings(){let e=this.getGlobalDefault(),t=`
