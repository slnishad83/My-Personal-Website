import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{A as t,C as n,D as r,E as i,I as a,M as o,N as s,S as c,T as l,_ as u,b as d,f,i as p,j as m,k as h,n as g,p as _,s as v,t as y,u as b}from"./feature-security-B7iC-g0p.js";var x,S;e((()=>{s(),n(),a((()=>{i(),c(),r((()=>{u(),y(),l((()=>{h(),v(),d((()=>{t(),_(),m((()=>{g(),f(),p((()=>{b(),x=o((()=>{(function(){let e=null,t=null,n=``,r={},i=null,a=null;function o(){let e=Object.keys(r);if(e.length<=200)return;let t=e.length-200;for(let n=0;n<t;n++)delete r[e[n]];try{localStorage.setItem(`ai_chat_tags`,JSON.stringify(r))}catch{}}function s(){a&&(a.disconnect(),a=null)}function c(){if(document.getElementById(`ai-features-css`))return;let e=document.createElement(`style`);e.id=`ai-features-css`,e.textContent=`
