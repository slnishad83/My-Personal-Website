import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{a as t,f as n,g as r,l as i,p as a,s as o,t as s,u as c}from"./feature-security-DB1Hds1N.js";var l,u;e((()=>{a(),o(),r((()=>{i(),s(),c((()=>{n(),l=t((()=>{var e=/@aibot\b|@ai\b/i;function t(t){return e.test(t||``)}function n(e){return(e||``).replace(/@aibot\b/gi,``).replace(/@ai\b/gi,``).replace(/\s{2,}/g,` `).trim()}function r(){let e=document.getElementById(`messagesArea`);if(!e)return null;let t=`ai-thinking-${Date.now()}`,n=document.createElement(`div`);return n.id=t,n.className=`message ai-bot-message ai-bot-thinking`,n.innerHTML=`
