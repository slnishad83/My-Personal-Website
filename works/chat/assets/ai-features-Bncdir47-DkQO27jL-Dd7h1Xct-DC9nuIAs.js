import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{a as t,f as n,g as r,l as i,p as a,s as o,t as s,u as c}from"./feature-security-DB1Hds1N.js";var l,u;e((()=>{a(),o(),r((()=>{i(),s(),c((()=>{n(),l=t((()=>{(function(){let e=null,t=null,n=``,r={},i=null,a=null;function o(){let e=Object.keys(r);if(e.length<=200)return;let t=e.length-200;for(let n=0;n<t;n++)delete r[e[n]];try{localStorage.setItem(`ai_chat_tags`,JSON.stringify(r))}catch{}}function s(){a&&(a.disconnect(),a=null)}function c(){if(document.getElementById(`ai-features-css`))return;let e=document.createElement(`style`);e.id=`ai-features-css`,e.textContent=`
