import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{A as t,C as n,D as r,E as i,I as a,M as o,N as s,S as c,T as l,_ as u,b as d,f,i as p,j as m,k as h,n as g,p as _,s as v,t as y,u as b}from"./feature-security-B7iC-g0p.js";var x,S;e((()=>{s(),n(),a((()=>{i(),c(),r((()=>{u(),y(),l((()=>{h(),v(),d((()=>{t(),_(),m((()=>{g(),f(),p((()=>{b(),x=o((()=>{(function(){window.PinnedHeader={_container:null,async show(e){if(this.hide(),!e)return;let t=window.App?.db;if(t)try{let n=await t.collection(`pinnedMessages`).where(`chatId`,`==`,e).orderBy(`pinnedAt`,`desc`).limit(3).get();if(n.empty)return;let r=[];n.forEach(e=>r.push({id:e.id,...e.data()})),this._container=document.createElement(`div`),this._container.id=`pinned-header-bar`,this._container.style.cssText=`display:flex;align-items:center;gap:10px;padding:8px 16px;background:var(--surface-container,#fff);border-bottom:1px solid var(--outline-variant,#eee);cursor:pointer;transition:background 0.15s;flex-shrink:0;`;let i=r[0],a=i.senderName||i.senderId||`Unknown`,o=i.text||i.content||``,s=r.length;this._container.innerHTML=`
