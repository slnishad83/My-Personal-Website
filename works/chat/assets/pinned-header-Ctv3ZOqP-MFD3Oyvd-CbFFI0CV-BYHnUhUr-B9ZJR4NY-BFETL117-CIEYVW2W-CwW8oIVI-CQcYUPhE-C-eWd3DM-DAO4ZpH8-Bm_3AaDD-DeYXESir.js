import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{C as t,E as n,H as r,J as i,K as a,N as o,P as s,S as c,T as l,W as u,X as d,Z as f,a as p,c as m,f as h,g,h as _,i as v,it as y,j as b,k as x,l as S,n as C,o as w,q as T,rt as E,st as D,t as O,tt as k,u as A,v as j,w as M,x as N,y as P,z as F}from"./feature-security-BOsqIJu9.js";var I,L;e((()=>{y(),u(),D((()=>{i(),E(),f((()=>{F(),l(),T((()=>{s(),g(),r((()=>{n(),h(),k((()=>{w(),m(),v((()=>{a(),c(),p((()=>{j(),P(),C((()=>{_(),O(),N((()=>{x(),t(),M((()=>{S(),o(),A((()=>{b(),I=d((()=>{(function(){window.PinnedHeader={_container:null,async show(e){if(this.hide(),!e)return;let t=window.App?.db;if(t)try{let n=await t.collection(`pinnedMessages`).where(`chatId`,`==`,e).orderBy(`pinnedAt`,`desc`).limit(3).get();if(n.empty)return;let r=[];n.forEach(e=>r.push({id:e.id,...e.data()})),this._container=document.createElement(`div`),this._container.id=`pinned-header-bar`,this._container.style.cssText=`display:flex;align-items:center;gap:10px;padding:8px 16px;background:var(--surface-container,#fff);border-bottom:1px solid var(--outline-variant,#eee);cursor:pointer;transition:background 0.15s;flex-shrink:0;`;let i=r[0],a=i.senderName||i.senderId||`Unknown`,o=i.text||i.content||``,s=r.length;this._container.innerHTML=`
