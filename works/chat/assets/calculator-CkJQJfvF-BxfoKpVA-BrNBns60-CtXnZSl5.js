import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{a as t,f as n,g as r,l as i,p as a,s as o,t as s,u as c}from"./feature-security-DB1Hds1N.js";var l,u;e((()=>{a(),o(),r((()=>{i(),s(),c((()=>{n(),l=t((()=>{(function(){let e=null,t=!1,n=0,r=0,i=null,a=null,o=``,s=`0`,c=[];function l(){u(),d(),f(),g()}function u(){if(document.getElementById(`calc-styles`))return;let e=document.createElement(`style`);e.id=`calc-styles`,e.textContent=`
      .calc-widget {
        position: fixed;
        right: 24px;
        top: 80px;
