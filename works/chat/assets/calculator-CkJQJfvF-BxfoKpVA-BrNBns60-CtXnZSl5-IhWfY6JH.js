import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{_ as t,c as n,d as r,f as i,i as a,m as o,n as s,p as c,r as l,v as u,x as d}from"./feature-security-Cee0Tjzu.js";var f,p;e((()=>{u(),r(),d((()=>{c(),l(),o((()=>{n(),s(),i((()=>{a(),f=t((()=>{(function(){let e=null,t=!1,n=0,r=0,i=null,a=null,o=``,s=`0`,c=[];function l(){u(),d(),f(),g()}function u(){if(document.getElementById(`calc-styles`))return;let e=document.createElement(`style`);e.id=`calc-styles`,e.textContent=`
      .calc-widget {
        position: fixed;
        right: 24px;
        top: 80px;
