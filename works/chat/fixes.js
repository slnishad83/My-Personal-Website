...
`;
  ...
  function _toast(msg, type) { if (App && App.toast) App.toast(msg, type); else if (typeof window.showToast === "function") window.showToast(msg, type); else if (window.__DEBUG__) console.log("[fixes] " + msg); }
