import{t as e}from"./modulepreload-polyfill-1QPZNIo4.js";var t=e((()=>{(function(){let e={greeting:[`Hey there!`,`Hi!`,`Hello, how are you?`],agreement:[`Agreed.`,`Sounds good.`,`Yes, absolutely.`],gratitude:[`Thank you!`,`Thanks a lot!`,`Appreciate it.`],farewell:[`Bye!`,`See you later.`,`Take care.`],question:[`I am not sure.`,`Let me check and get back to you.`,`Can you clarify?`],default:[`Okay.`,`Got it.`,`Thanks.`]},t=null,n=null,r=!1;function i(){let e=document.createElement(`style`);e.textContent=`
