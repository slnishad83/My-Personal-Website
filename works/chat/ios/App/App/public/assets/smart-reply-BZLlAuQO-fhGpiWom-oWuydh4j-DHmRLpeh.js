import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{a as t,f as n,g as r,l as i,p as a,s as o,t as s,u as c}from"./feature-security-DB1Hds1N.js";var l,u;e((()=>{a(),o(),r((()=>{i(),s(),c((()=>{n(),l=t((()=>{(function(){let e={greeting:[`Hey there!`,`Hi!`,`Hello, how are you?`],agreement:[`Agreed.`,`Sounds good.`,`Yes, absolutely.`],gratitude:[`Thank you!`,`Thanks a lot!`,`Appreciate it.`],farewell:[`Bye!`,`See you later.`,`Take care.`],question:[`I am not sure.`,`Let me check and get back to you.`,`Can you clarify?`],default:[`Okay.`,`Got it.`,`Thanks.`]},t=null,n=null,r=!1;function i(){let e=document.createElement(`style`);e.textContent=`
