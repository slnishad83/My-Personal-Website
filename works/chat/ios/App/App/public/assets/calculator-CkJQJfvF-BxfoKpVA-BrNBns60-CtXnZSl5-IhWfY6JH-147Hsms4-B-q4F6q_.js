import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{C as t,D as n,E as r,O as i,S as a,T as o,a as s,b as c,d as l,h as u,i as d,j as f,l as p,s as m,u as h,v as g,x as _}from"./feature-security-BDorBO9o.js";var v,y;e((()=>{i(),c(),f((()=>{a(),l(),t((()=>{u(),p(),_((()=>{o(),h(),g((()=>{r(),d(),n((()=>{s(),v=m((()=>{(function(){let e=null,t=!1,n=0,r=0,i=null,a=null,o=``,s=`0`,c=[];function l(){u(),d(),f(),g()}function u(){if(document.getElementById(`calc-styles`))return;let e=document.createElement(`style`);e.id=`calc-styles`,e.textContent=`
      .calc-widget {
        position: fixed;
        right: 24px;
        top: 80px;
