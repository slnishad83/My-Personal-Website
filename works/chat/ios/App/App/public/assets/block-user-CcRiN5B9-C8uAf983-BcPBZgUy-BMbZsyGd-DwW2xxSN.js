import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{_ as t,c as n,d as r,f as i,i as a,m as o,n as s,p as c,r as l,v as u,x as d}from"./feature-security-Cee0Tjzu.js";var f,p;e((()=>{u(),r(),d((()=>{c(),l(),o((()=>{n(),s(),i((()=>{a(),f=t((()=>{(function(){var e=function(){return App&&App.uid?App.uid():window.currentUser?window.currentUser.uid:null};function t(e){if(typeof window.escHtml==`function`)return window.escHtml(e);var t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function n(){var t=e();return t?db.collection(`users`).doc(t):null}function r(e,t){App&&App.toast?App.toast(e,t):typeof showToast==`function`&&showToast(e,t)}async function i(){var e=n();if(e)try{await e.set({blockedUsers:window.blockedUsers||[]},{merge:!0})}catch(e){window.__DEBUG__&&console.error(`[Block] persist failed`,e)}}async function a(){var e=n();if(e)try{var t=await e.get();if(t.exists){var r=t.data();Array.isArray(r.blockedUsers)&&(window.blockedUsers=r.blockedUsers)}}catch(e){window.__DEBUG__&&console.error(`[Block] load failed`,e)}}function o(){Array.isArray(window.blockedUsers)||(window.blockedUsers=[])}function s(){if(!document.getElementById(`block-user-styles`)){var e=document.createElement(`style`);e.id=`block-user-styles`,e.textContent=`
...
<button class="blocked-user-unblock">Unblock</button>`,(function(t,n){d.querySelector(`.blocked-user-unblock`).addEventListener(`click`,function(){window.unblockUser(t,n),e.classList.remove(`open`),setTimeout(function(){e.remove()},200),setTimeout(function(){window.showBlockedUsersList()},300)})})(i[a],l),r.appendChild(d)}requestAnimationFrame(function(){e.classList.add(`open`)}),n.querySelector(`.blocked-users-close`).addEventListener(`click`,function(){e.classList.remove(`open`),setTimeout(function(){e.remove()},200)}),e.addEventListener(`click`,function(t){t.target===e&&(e.classList.remove(`open`),setTimeout(function(){e.remove()},200))})};function u(){var e=document.getElementById(`chat-header-name`)||document.getElementById(`chat-user-name`);if(e){var t=e.parentElement.querySelector(`.blocked-indicator`);if(t&&t.remove(),typeof currentChat<`u`&&currentChat&&currentChat.id&&window.isUserBlocked(currentChat.id)){var n=document.createElement(`div`);n.className=`blocked-indicator`,n.textContent=`ðŸš« Blocked`,e.parentElement.appendChild(n)}}}function d(){o();for(var e=document.querySelectorAll(`.chat-list-item[data-chat-id]`),t=0;t<e.length;t++){var n=e[t].dataset.chatId;window.isUserBlocked(n)&&(e[t].style.display=`none`)}}function f(){s(),a().then(function(){d(),u()})}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,f):f()})()})),p=f()}))()}))()}))()}))();export{p as default};