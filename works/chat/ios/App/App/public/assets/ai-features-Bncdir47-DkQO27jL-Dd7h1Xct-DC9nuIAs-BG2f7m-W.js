import{n as e}from"./modulepreload-polyfill-C_LrRQgL.js";import{_ as t,c as n,d as r,f as i,i as a,m as o,n as s,p as c,r as l,v as u,x as d}from"./feature-security-Cee0Tjzu.js";var f,p;e((()=>{u(),r(),d((()=>{c(),l(),o((()=>{n(),s(),i((()=>{a(),f=t((()=>{(function(){let e=null,t=null,n=``,r={},i=null,a=null;function o(){let e=Object.keys(r);if(e.length<=200)return;let t=e.length-200;for(let n=0;n<t;n++)delete r[e[n]];try{localStorage.setItem(`ai_chat_tags`,JSON.stringify(r))}catch{}}function s(){a&&(a.disconnect(),a=null)}function c(){if(document.getElementById(`ai-features-css`))return;let e=document.createElement(`style`);e.id=`ai-features-css`,e.textContent=`
