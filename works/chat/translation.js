...
(function () {
  ...
  function _showAutoTranslateDialog() {
    ...
    dialog.innerHTML = '<div style="background:var(--surface-container,#1a1b2e);border:1px solid var(--outline-variant,rgba(255,255,255,0.12));border-radius:20px;padding:24px;max-width:360px;width:90%;box-shadow:0 8px 32px rgba(0,0,0,0.5)"><div style="display:flex;align-items:center;gap:10px;margin-bottom:16px"><span class="material-symbols-outlined" style="color:var(--primary);font-size:24px">translate</span><span style="font-size:16px;font-weight:700;color:var(--on-surface)">Auto-Translate</span></div><p style="font-size:12px;color:var(--on-surface-variant);margin-bottom:16px">Automatically translate incoming messages in this chat to your preferred language.</p><div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px"><span style="font-size:14px;color:var(--on-surface)">Enable auto-translate</span><label class="toggle-track' + (isEnabled ? ' active' : '') + '" style="cursor:pointer"><input type="checkbox" id="auto-translate-toggle"' + (isEnabled ? ' checked' : '') + ' style="opacity:0;width:0;height:0"><div class="toggle-knob"></div></label></div><div style="margin-bottom:16px"><label style="font-size:12px;font-weight:600;color:var(--on-surface-variant);display:block;margin-bottom:6px">Target Language</label><select id="auto-translate-lang" style="width:100%;padding:10px 14px;border-radius:12px;border:1px solid var(--outline-variant,rgba(255,255,255,0.12));background:var(--surface-container-high,rgba(255,255,255,0.06));color:var(--on-surface);font-size:14px">' + optionsHtml + '</select></div><div style="display:flex;gap:8px"><button onclick="document.getElementById(\'auto-translate-dialog\').remove()" style="flex:1;padding:10px;border-radius:12px;border:none;background:var(--surface-container-high,rgba(255,255,255,0.06));color:var(--on-surface);font-weight:600;cursor:pointer">Cancel</button><button id="auto-translate-save" style="flex:1;padding:10px;border-radius:12px;border:none;background:var(--primary);color:var(--on-primary);font-weight:700;cursor:pointer">Save</button></div></div>';
